...
* Based on the results from step-wise selection, my proposed model is: `bwt` = `\beta_0` + `\beta_1` `babysex2` + `\beta_2` `bhead` + `\beta_3` `blength` + `\beta_4` `delwt` + `\beta_5` `fincome` + `\beta_6` `gaweeks` + `\beta_7` `mheight` + `\beta_8` `mrace2` + `\beta_9` `mrace3` + `\beta_10` `mrace4`  + `\beta_11` `parity` + `\beta_12` `ppwt` + `\beta_13` `smoken`
